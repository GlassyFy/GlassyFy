...
func hoja3(RI: Double, Mg: Double, Al: Double, K: Double, Ca: Double, Ba: Double) -> String {
    tipoCristal["buildWindFloat"] = 124.97 + RI * -78.58 + Mg * 1.28 + Al * -3.05 + K * -4.5 + Ca * -0.28 + Ba * -23.86
    
    tipoCristal["buildWindNonFloat"] = -815.23 + RI * 619.01 + Mg * -36.66 + Al * -3.17 + K * 7.46 + Ca * -0.02 + Ba * -7.98
    
    tipoCristal["vehicWindFloat"] = 1151 + RI * -753.53 + Mg * 1.77 + Al * -4.44 + K * -3.4 + Ca * -0.46 + Ba * 19.21
    
    tipoCristal["vehicWindNonFloat"] = -61.93 + Mg * 0.01 + Al * -0

    tipoCristal["containers"] = 7.24 + RI * -38.05 + Mg * -1.25 + Al * 3.98 + K * 0.49 + Ca * 0.46 + Ba * 2.46
    
    tipoCristal["tableware"] = 144.61 + RI * -118.9 + Mg * -0.21 + Al * 3.9  + K * -112.96 + Ca * -0.54 + Ba * -3.04
    
    tipoCristal["headlamps"] = -5209.15 + RI * 3431.78 + Mg * -10.39 + Al * 0.36 + K * 45.07 + Ca * -1.31 + Ba * 1.62
...
func hoja4(RI: Double, Mg: Double, Al: Double, K: Double, Ca: Double, Ba: Double) -> String {
    tipoCristal["buildWindFloat"] = 728.29 + RI * -459.52 + Mg * -5.69 + Al * 4.94 + K * 5.37 + Ca * -1.98 + Ba * 2.64
    
    tipoCristal["buildWindNonFloat"] = -1617.23 + RI * 1054.98 + Mg * 5.41 + Al * -6.64 + K * -11.03 + Ca * 1.43 + Ba * -22.61
    
    tipoCristal["vehicWindFloat"] = 1245.5 + RI * -827.3 + Mg * 0.61 + Al * -4.27 + K * -11.8 + Ca * 0.83 + Ba * 13.29
    ...
    tipoCristal["headlamps"] = -9775.23 + RI * 6415.58 + Mg * -14.54 + Al * 0.36 + K * 132.96 + Ca * -1.31 + Ba * 1.62
...
func hoja5(RI: Double, Mg: Double, Al: Double, K: Double, Ca: Double, Ba: Double) -> String {
    tipoCristal["buildWindFloat"] = 727.54 + RI * -493.91 + Mg * 3.48 + Al * -4.86 + K * -0.36 + Ca * 0.82 + Ba * -22.55
    
    tipoCristal["buildWindNonFloat"] = 70.65 + RI * 41.45 + Mg * -12.14 + Al * -19.31 + K * -4.32 + Ca * -6.88 + Ba * 8.25
    
    tipoCristal["vehicWindFloat"] = -275.01 + RI * 58.48 + Mg * 16.96 + Al * 21.12 + K * 1.37 + Ca * 11.22 + Ba * 1.81
    ...
    tipoCristal["headlamps"] = -2820.83 + RI * 1845.88 + Mg * -1.05 + Al * 0.36 + K * 13.17 + Ca * -1.31 + Ba * 1.62
...
func hoja6(RI: Double, Mg: Double, Al: Double, K: Double, Ca: Double, Ba: Double) -> String {
    ...
    tipoCristal["buildWindNonFloat"] = -624.35 + RI * 431.01 + Mg * 2.29 + Al * -4.14 + K * 4.5  + Ca * -3.9 + Ba * 23.09
    
    tipoCristal["vehicWindFloat"] = 37.03 + RI * -85.69 + Mg * 4.76 + Al * 5.66 + K * -3.1 + Ca * 6.83 + Ba * 1.81
